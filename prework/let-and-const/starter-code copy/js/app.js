...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT:cause when converted it to let being local scope and if we want to solve the error without deleting we can move the console up into the big while loop
  console.log(viewed);
